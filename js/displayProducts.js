document.addEventListener("DOMContentLoaded", () => {
    ...
    const initialFixedProducts = [
        ...
        { id: 'prod_005', name: "Verniz interior aquoso acetinado e transparente 0,25l", reference: "82179513", price: 7.73, stock: 10, description: null, image: "../assets/images/verniz.png", pricePerUnit: null, pricePerLitre: 30.92 },
        { id: 'prod_006', name: "Rolo fita Semi-Crep 45m x 48 mm", reference: "82556833", price: 3.44, stock: 48, description: null, image: "../assets/images/rolo_fitacola.png", pricePerUnit: null, pricePerLitre: null },
        { id: 'prod_007', name: "Tinta plástica antibolor antiverdete. Mate seda branca 4L. REVEPROA", reference: "84684317", price: 48.69, stock: 21, description: "Tinta plástica mate seda branca com propriedades antibolores e antiverdete. Volume: 4 litros.", image: "../assets/images/tinta_plastica.png", pricePerUnit: null, pricePerLitre: 12.17 },
        { id: 'prod_008', name: "Misturador 14Mm/1600W Werku WK400130", reference: "82799953", price: 142.01, stock: 0, description: null, image: "../assets/images/misturador.png", pricePerUnit: null, pricePerLitre: null },
        { id: 'prod_009', name: "Óleo para teca. Proteção e nutrição para a madeira transparente 0,75L", reference: "82401638", price: 7.90, stock: 28, description: null, image: "../assets/images/oleo.png", pricePerUnit: null, pricePerLitre: 10.53 }
    ];
